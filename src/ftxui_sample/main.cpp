...
// configuration step. It creates a namespace called `k`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", k::cmake::project_name, k::cmake::project_version) };
